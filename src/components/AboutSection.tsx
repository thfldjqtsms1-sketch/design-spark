              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="font-display text-2xl text-foreground mb-2">FORMA</p>
                    <p className="text-muted-foreground text-sm tracking-[0.3em]">건축 디자인 그룹</p>
                  </div>
                </div>
                
                {/* Decorative Elements */}
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-gold" />
                <div className="absolute bottom-0 right-0 w-1 h-full bg-gradient-gold" />
              </motion.div>
