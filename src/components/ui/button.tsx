  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        // Custom architecture variants
        gold: "bg-primary text-primary-foreground hover:shadow-[0_0_30px_hsl(40,65%,55%,0.3)] hover:scale-[1.02] font-medium",
        "gold-outline": "border border-primary text-primary hover:bg-primary hover:text-primary-foreground",
        hero: "bg-transparent border border-foreground/30 text-foreground hover:border-primary hover:text-primary backdrop-blur-sm",
        minimal: "text-foreground hover:text-primary underline-offset-8 hover:underline decoration-primary",
      },
      size: {
