      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              {/* Icon */}
              <div className="w-14 h-14 mb-6 flex items-center justify-center border border-border group-hover:border-primary group-hover:bg-primary/10 transition-all duration-500">
